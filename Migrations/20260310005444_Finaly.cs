...
namespace Adenawell_ValentinAP1_P2.Migrations
{
    /// <inheritdoc />
    public partial class Finaly : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AsignacionPuntos", x => x.IdAsignacion);
                    table.ForeignKey(
                        name: "FK_AsignacionPuntos_Estudiantes_EstudianteId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Detalles_AsignacionPuntos_AsignacionesPuntosIdAsignacion",
                        column: x => x.AsignacionesPuntosIdAsignacion,
                        principalTable: "AsignacionPuntos",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AsignacionPuntos_EstudianteId",
                table: "AsignacionPuntos",
                column: "EstudianteId");

            migrationBuilder.CreateIndex(
                name: "IX_Detalles_AsignacionesPuntosIdAsignacion",
                table: "Detalles",
